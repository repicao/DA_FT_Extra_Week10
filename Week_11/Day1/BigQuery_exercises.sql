-- Using the NYC Taxi public dataset from Google BigQuery, complete the following exercises:

-- Exercise 1: Count the number of trips in January 2020


-- Exercise 2: Calculate the total revenue generated by taxi trips in 2020
